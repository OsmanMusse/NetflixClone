...
enum NotificationName: CaseIterable{
  ...
  case didHomeScreenScrollUp
  case didHomeScreenScrollDown
}
...
extension NotificationName {
    ...
    var name: Notification.Name {
        ...
        case .didHomeScreenScrollUp: return Notification.Name(rawValue: "didHomeScreenScrollUp")
        case .didHomeScreenScrollDown: return Notification.Name(rawValue: "didHomeScreenScrollDown")
        }
    }
