...
class HomeScreen: UICollectionViewController, UICollectionViewDelegateFlowLayout, HomeScreenRefreshDelegate, SingleVideoHeaderDelegate{
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        switch section{
        case 1: return 1
        case 2: return videoInformation.count
        case 3 : return 1
        default: return 0
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        case 0: return CGSize(width: view.frame.width, height: 140)
        case 3:   return CGSize(width: view.frame.width, height: 350)
        default:  return CGSize(width: view.frame.width - 2 * padding, height: 190)
        }
    ...
    override func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let scrollDownNotification = Notification(name: NotificationName.didHomeScreenScrollDown.name)
        let scrollUpNotification = Notification(name: NotificationName.didHomeScreenScrollUp.name)
        if offsetY < 550 {
            NotificationCenter.default.post(scrollUpNotification)
        }
        else if offsetY > 550 {
            NotificationCenter.default.post(scrollDownNotification)
        }
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: previewsCellId, for: indexPath)
            return cell
        }
        ...
        if myListData.count > 0, indexPath.section == 1{
